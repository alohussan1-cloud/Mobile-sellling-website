...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav>
      ...
      <a href="admin-customer.php" class="nav-item <?= ($page == 'admin-customer.php') ? 'active' : '' ?>"><i class="fa-solid fa-user"></i> Customers</a>
    
      <a href="admin-logout.php" class="nav-item logout"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
    </nav>
  </aside>
</body>
</html>